...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/shy-band-6302#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/shy-band-6302
```

A live public deployment of this template is available at [https://shy-band-6302.templates.workers.dev](https://shy-band-6302.templates.workers.dev)
